...
const Home = () => {
  ...
  return (
    ...
    >
      <Navbar />
      <div className="flex flex-col lg:flex-row justify-between h-full md:h-5/6 mt-10">
        <div className="flex flex-col mx-16 gap-6 lg:my-auto">
          <h2 className="text-center tracking-widest text-xl md:text-3xl font-barlow-condensed text-blue-300">
            SO, YOU WANT TRAVEL TO
          </h2>
          <h1 className="text-center text-8xl md:text-[9rem] font-bellefair">
            SPACE
          </h1>
          <p className="text-center leading-[180%] text-blue-300 w-4/5 md:w-[35rem] m-auto lg:m-0">
        ...
        <div className="m-auto relative z-10 group">
          <div
            id="buttonEffect"
